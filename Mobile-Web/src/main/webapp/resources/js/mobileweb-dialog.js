	...
	open: function() {
		...
		if ( ( o.dialogAllow === true && coords.width < 400 ) || o.dialogForce ) {
			...
			if ( o.fullScreen === true && ( coords.width < 400 || o.fullScreenForce === true ) ) {
				...
				self.sdIntContent.css({'position': 'absolute', 'top': coords.fulltop,'overflow':'auto', 'max-height':$.mobile.activePage.height()-(2*(coords.fullTop)), 'left': coords.winLeft}).removeClass('ui-simpledialog-hidden');
			}
