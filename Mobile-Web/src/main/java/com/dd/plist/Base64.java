 ...
 * </p>
 * <ul>
 * <li>Some minor modifications for inclusion in com.dd.plist by Daniel
 * Dreibrodt</li>
...
public class Base64 {
	...
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			...
			b64os = new Base64.Base64OutputStream(baos, ENCODE | options);
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new Base64.Base64OutputStream(new java.io.FileOutputStream(
	...
	public static byte[] decodeFromFile(String filename) {
		...
		try {
			...
			// Open a stream
			bis = new Base64.Base64InputStream(new java.io.BufferedInputStream(
	...
	public static boolean encodeFileToFile(String infile, String outfile) {
		...
		try {
			in = new Base64.Base64InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(infile)), Base64.ENCODE);
	...
	public static class Base64InputStream extends java.io.FilterInputStream {
		 ...
		 * <p>
		 * Example:
		 * <code>new Base64.Base64InputStream( in, Base64.DECODE )</code>
		 * 
		 * 
		 * @param in
		 *            the <tt>java.io.InputStream</tt> from which to read data.
	...
	public static class Base64OutputStream extends java.io.FilterOutputStream {
		 ...
		 * <p>
		 * Example:
		 * <code>new Base64.Base64OutputStream( out, Base64.ENCODE )</code>
		 * 
		 * @param out
		 *            the <tt>java.io.OutputStream</tt> to which data will be
		 *            written.
