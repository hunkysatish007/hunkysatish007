...
public class NSNumber extends NSObject {
	...
	/**
	 * Indicates that the number's value is an integer. This can either be a
	 * Java <code>long</code> or <code>int</code>.
	 **/
	public static final int INTEGER = 0;
	/**
	 * Indicates that the number's value is a real number. This is a Java
	 * <code>double</code>.
	 **/
	...
	public NSNumber(byte[] bytes, int type) {
		...
		case INTEGER: {
			// TODO enable long
			doubleValue = longValue = BinaryPropertyListParser
	 ...
	 *             If the text does not represent an integer, real number or
	 *             boolean value.
	 */
			...
			try {
				...
				try {
					...
					throw new IllegalArgumentException(
							"Given text neither represents a double, int or boolean value.");
				}
			}
		}
	 ...
	 * 
	 * @return <code>true</code> if the value is true or non-zero, false</code>
	 *         otherwise.
	 */
	...
	/**
	 * The number's int value. <i>Note: Even though the number's type might be
	 * INTEGER it can be larger than a Java int. Use intValue() only if you are
	 * certain that it contains a number from the int range. Otherwise the value
	 * might be innaccurate.</i>
	 * 
	...
	/**
	 * Checks whether the other object is a NSNumber of the same value. The type
	 * is ignored, what matters is the numeric value.
	 * 
	 * @param obj
